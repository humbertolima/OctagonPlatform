    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Partners", t => t.PartnerId)
                .ForeignKey("dbo.ReportGroups", t => t.ReportGroupId)
                .ForeignKey("dbo.States", t => t.StateId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Terminals", t => t.IndexId)
                .Index(t => t.IndexId);
            ...
            CreateTable(
                "dbo.ReportModelUsers",
                c => new
                    {
                        ReportModel_Id = c.Int(nullable: false),
                        User_Id = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.ReportModel_Id, t.User_Id })
                .ForeignKey("dbo.Reports", t => t.ReportModel_Id)
                .ForeignKey("dbo.Users", t => t.User_Id)
                .Index(t => t.ReportModel_Id)
                .Index(t => t.User_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ReportModelUsers", "User_Id", "dbo.Users");
            DropForeignKey("dbo.ReportModelUsers", "ReportModel_Id", "dbo.Reports");
            ...
            DropForeignKey("dbo.Terminals", "ReportGroupId", "dbo.ReportGroups");
            ...
            DropForeignKey("dbo.Disputes", "IndexId", "dbo.Terminals");
            ...
            DropIndex("dbo.ReportModelUsers", new[] { "User_Id" });
            DropIndex("dbo.ReportModelUsers", new[] { "ReportModel_Id" });
            ...
            DropIndex("dbo.Subscriptions", new[] { "ScheduleId" });
            ...
            DropIndex("dbo.Terminals", new[] { "ReportGroupId" });
            ...
            DropTable("dbo.ReportModelUsers");
