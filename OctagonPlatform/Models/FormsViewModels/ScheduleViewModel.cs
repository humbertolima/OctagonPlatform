...
namespace OctagonPlatform.Models.FormsViewModels
{
    public class ScheduleViewModel
    {
        public ScheduleViewModel()
        {
            ...
            DropDownRepeatOnFirst.Add(new SelectListItem { Value = "first", Text = "First" });
            DropDownRepeatOnFirst.Add(new SelectListItem { Value = "second", Text = "Second" });
            DropDownRepeatOnFirst.Add(new SelectListItem { Value = "third", Text = "Third" });
            DropDownRepeatOnFirst.Add(new SelectListItem { Value = "fourth", Text = "Fourth" });
            DropDownRepeatOnFirst.Add(new SelectListItem { Value = "last", Text = "Last" });
            DropDownRepeatOnDay2 = new List<SelectListItem>();
            DropDownRepeatOnDay2.Add(new SelectListItem { Value = "sunday", Text = "Sunday" });
            DropDownRepeatOnDay2.Add(new SelectListItem { Value = "monday", Text = "Monday" });
            DropDownRepeatOnDay2.Add(new SelectListItem { Value = "tuesday", Text = "Tuesday" });
            DropDownRepeatOnDay2.Add(new SelectListItem { Value = "wednesday", Text = "Wednesday" });
            DropDownRepeatOnDay2.Add(new SelectListItem { Value = "thursday", Text = "Thursday" });
            DropDownRepeatOnDay2.Add(new SelectListItem { Value = "friday", Text = "Friday" });
            DropDownRepeatOnDay2.Add(new SelectListItem { Value = "saturday", Text = "Saturday" });
